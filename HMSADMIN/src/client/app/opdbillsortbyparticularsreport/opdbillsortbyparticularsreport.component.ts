...
@Component({
  moduleId: module.id,
  selector: 'sd-opdbillsortbyparticularsreport',
  templateUrl: 'opdbillsortbyparticularsreport.component.html',
  styleUrls: ['opdbillsortbyparticularsreport.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class OpdbillsortbyparticularsreportComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: OpdbillsortbyparticularsreportService,
  ...
  onSubmit(){
    ...
    printReceipt(){
      ...
      this.localService.printreportforopdbillsortbyparticulars(this.hospitalID,strfromdate,strtodate).subscribe(         
        /* happy path */ p => {
             resultofws=p;
  ...
  printReceiptDetails(){
      ...
      this.localService.printreportforopdbillsortbyparticularsdetails(this.hospitalID,strfromdate,strtodate).subscribe(         
        /* happy path */ p => {
             resultofws=p;
