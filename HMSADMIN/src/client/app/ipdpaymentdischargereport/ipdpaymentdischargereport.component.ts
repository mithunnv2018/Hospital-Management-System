...
@Component({
  moduleId: module.id,
  selector: 'sd-ipdpaymentdischargereport',
  templateUrl: 'ipdpaymentdischargereport.component.html',
  styleUrls: ['ipdpaymentdischargereport.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class IpdpaymentdischargereportComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: IpdpaymentdischargereportService,
  ...
  onSubmit(){
    ...
    printReceipt(){
      ...
      this.localService.printreportforipdpaymentdischarge(this.hospitalID,strfromdate,strtodate).subscribe(         
        /* happy path */ p => {
             resultofws=p;
