...
import { opdpatricularreceiptTS } from '../../billing/billing';
...
export class BillingService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'billing/';
...
get_WS_adminfees_sum_groupby_selectjson(inparam0: string): Observable<opdpatricularreceiptTS[]>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_adminfees_sum_groupby_selectjson`;
...
get_WS_concession_adminfees(inparam0: string,inparam1: string): Observable<string>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}&input1=${ inparam1}`;
var url2 = `${this.baseUrl}WS_concession_adminfees`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
getWS_hsp_ipd_advancesum(inparam0: string): Observable<string>{
  let headers1 = new Headers();

  headers1.append('Content-Type', 'application/x-www-form-urlencoded');
  var body1 = `input0=${ inparam0}`;
  var url2 = `${this.baseUrl}WS_hsp_ipd_advancesum`;
  let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
  .map((res:Response) => res.json()).catch(this.handleError);
  return returnval$;
}
...
printreportforbilling(inparam0: string): Observable<Reportresult>{
let headers1 = new Headers();
...
printreportforthebill(inparam0: string): Observable<Reportresult>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `param_adminid=${ inparam0}`;
var url2 = `${this.baseUrlreport}WS_TheBillReport`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
// .map((res:Response) => res.text()).catch(this.handleError);
return returnval$;
...
printreportfordetailedfinalreport(inparam0: string): Observable<Reportresult>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `param_adminid=${ inparam0}`;
var url2 = `${this.baseUrlreport}WS_IPDDetailedfinalreport`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
// .map((res:Response) => res.text()).catch(this.handleError);
return returnval$;
