...
import { IpddoctorchargesdetailsreportService } from './ipddoctorchargesdetailsreport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: IpddoctorchargesdetailsreportService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          IpddoctorchargesdetailsreportService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  IpddoctorchargesdetailsreportService);
