...
import { GenericmedicinemasterService } from './genericmedicinemaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: GenericmedicinemasterService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  GenericmedicinemasterService);
