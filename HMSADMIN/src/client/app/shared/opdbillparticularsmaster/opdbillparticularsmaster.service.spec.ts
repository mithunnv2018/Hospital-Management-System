...
import {  OpdbillparticularsMasterService } from './opdbillparticularsmaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService:  OpdbillparticularsMasterService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
           OpdbillparticularsMasterService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(   OpdbillparticularsMasterService);
