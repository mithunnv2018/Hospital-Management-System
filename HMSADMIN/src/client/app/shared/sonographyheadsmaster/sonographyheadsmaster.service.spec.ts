...
import { SonographyheadsMasterService } from './sonographyheadsmaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService:   SonographyheadsMasterService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  SonographyheadsMasterService);
