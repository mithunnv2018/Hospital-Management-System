...
import { HspdoctorvisitdetailsService } from './hspdoctorvisitdetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HspdoctorvisitdetailsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HspdoctorvisitdetailsService);
