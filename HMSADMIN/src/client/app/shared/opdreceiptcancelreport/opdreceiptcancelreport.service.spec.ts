...
import { OpdreceiptcancelreportService } from './opdreceiptcancelreport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: OpdreceiptcancelreportService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  OpdreceiptcancelreportService);
