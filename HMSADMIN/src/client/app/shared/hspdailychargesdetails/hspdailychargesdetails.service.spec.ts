...
import { HspdailychargesdetailsService } from './hspdailychargesdetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HspdailychargesdetailsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HspdailychargesdetailsService);
