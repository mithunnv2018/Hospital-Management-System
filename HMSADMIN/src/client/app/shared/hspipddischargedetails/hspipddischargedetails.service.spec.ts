...
import { HspipddischargedetailsService } from './hspipddischargedetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HspipddischargedetailsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HspipddischargedetailsService);
