...
import { IpdpaymentdischargereportService } from './ipdpaymentdischargereport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: IpdpaymentdischargereportService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          IpdpaymentdischargereportService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  IpdpaymentdischargereportService);
