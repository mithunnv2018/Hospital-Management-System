 ...
 */
@Injectable()
export class IpdpaymentdischargereportService {
...
printreportforipdpaymentdischarge(inparam0: string,inparam1: string,inparam2: string): Observable<Reportresult>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `param_hospitalid=${inparam0}&param_fromdate=${ inparam1}&param_todate=${ inparam2}`;
var url2 = `${this.baseUrlreport}IPDPaymentdischargereport`;
