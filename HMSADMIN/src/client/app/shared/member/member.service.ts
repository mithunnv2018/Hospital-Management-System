...
export class MemberService {
  ...
  //1.to insert member
  insert(inparam: Member): Observable<Member[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_member_master_create`;//insertMilestonesProject`;
  ...
  getall(): Observable<Member[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_member_master_selectjson`;//selectAllMilestone`;
  ...
  // 2.Update member
  update(inparam: Member): Observable<Member[]>{
    ...
    var body1 = `input=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_member_master_update`;//insertMilestonesProject`;
  ...
  // 4.On Edit get member
  getedit(pkid: string): Observable<Member>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_member_master_selectedit`;//selectEditMilestone`;
