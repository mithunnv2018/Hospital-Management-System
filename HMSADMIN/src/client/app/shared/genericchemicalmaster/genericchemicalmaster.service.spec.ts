...
import { GenericchemicalmasterService } from './genericchemicalmaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: GenericchemicalmasterService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  GenericchemicalmasterService);
