...
import { OpdbillcancelreportService } from './opdbillcancelreport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: OpdbillcancelreportService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  OpdbillcancelreportService);
