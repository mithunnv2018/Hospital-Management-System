...
import { IpdreceiptcancelService } from './ipdreceiptcancel.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: IpdreceiptcancelService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  IpdreceiptcancelService);
