...
import { OpdprescriptionService } from './opdprescription.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService:   OpdprescriptionService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(    OpdprescriptionService);
