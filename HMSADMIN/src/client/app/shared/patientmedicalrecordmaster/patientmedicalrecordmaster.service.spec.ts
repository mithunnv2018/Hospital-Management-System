...
import { PatientmedicalrecordMasterService } from './patientmedicalrecordmaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService:   PatientmedicalrecordMasterService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          PatientmedicalrecordMasterService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  PatientmedicalrecordMasterService);
