...
import { CosmeticbilldetailsService } from './cosmeticbilldetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService:   CosmeticbilldetailsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(    CosmeticbilldetailsService);
