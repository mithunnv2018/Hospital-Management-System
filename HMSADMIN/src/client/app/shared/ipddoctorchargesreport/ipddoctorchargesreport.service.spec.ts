...
import { OpdbillsortbyparticularsreportService } from './opdbillsortbyparticularsreport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: OpdbillsortbyparticularsreportService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          OpdbillsortbyparticularsreportService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  OpdbillsortbyparticularsreportService);
