 ...
 */
@Injectable()
export class IpdreceiptcancelreportService {
...
printreportforipdreceiptcancel(inparam0: string,inparam1: string): Observable<Reportresult>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `param_fromdate=${ inparam0}&param_todate=${ inparam1}`;
var url2 = `${this.baseUrlreport}WS_IPDReceiptCancelReport`;
