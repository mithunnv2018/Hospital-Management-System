...
import { IpdreceiptcancelreportService } from './ipdreceiptcancelreport.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: IpdreceiptcancelreportService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  IpdreceiptcancelreportService);
