...
import { SonographychargesService } from './sonographycharges.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: SonographychargesService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  SonographychargesService);
