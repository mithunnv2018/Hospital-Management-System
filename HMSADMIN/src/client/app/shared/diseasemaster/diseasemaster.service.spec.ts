...
import { DiseaseMasterService } from './diseasemaster.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: DiseaseMasterService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  DiseaseMasterService);
