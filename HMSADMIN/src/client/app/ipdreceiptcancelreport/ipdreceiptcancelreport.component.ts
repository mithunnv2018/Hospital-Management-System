...
@Component({
  moduleId: module.id,
  selector: 'sd-ipdreceiptcancelreport',
  templateUrl: 'ipdreceiptcancelreport.component.html',
  styleUrls: ['ipdreceiptcancelreport.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class IpdreceiptcancelreportComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: IpdreceiptcancelreportService,
  ...
  onSubmit(){
    ...
    printReceipt(){
      ...
      this.localService.printreportforipdreceiptcancel(strfromdate,strtodate).subscribe(         
        /* happy path */ p => {
             resultofws=p;
