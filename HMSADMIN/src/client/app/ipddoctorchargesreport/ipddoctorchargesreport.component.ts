...
@Component({
  moduleId: module.id,
  selector: 'sd-ipddoctorchargesreport',
  templateUrl: 'ipddoctorchargesreport.component.html',
  styleUrls: ['ipddoctorchargesreport.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class IpddoctorchargesreportComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: IpddoctorchargesreportService,
  ...
  onSubmit(){
    ...
    printReceipt(){
      ...
      this.localService.printreportforipddoctorcharges(this.hospitalID,strfromdate,strtodate).subscribe(         
        /* happy path */ p => {
             resultofws=p;
